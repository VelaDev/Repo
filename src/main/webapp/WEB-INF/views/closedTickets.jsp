							...
							<table id="myDatatable" class="display datatable">
								...
								<tbody>
									<c:forEach items="${ticketList}" var="tickets">
										<tr>
											<td><a href="closedTicketsDetails?id=<c:out value='${tickets.recordID}'/>"><c:out value="${tickets.ticketNumber}" /></a></td>
											<td><c:out value="${tickets.dateTime}" /></td>
											<td><c:out value="${tickets.device.serialNumber}" /></td>
											<td><c:out value="${tickets.description}" /></td>
											<td><c:out value="${tickets.employee.firstName}  ${tickets.employee.lastName}" /></td>										</tr>
									</c:forEach>
								</tbody>
							</table>
