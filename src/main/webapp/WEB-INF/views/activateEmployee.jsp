	...
	<div class="velaphanda_containter">	
		...
		<c:if test="${not empty retMessage }">
			...
			<div class="panel panel-success">    
				...
				<form action="searchEmployeeForActivation" method="post" id="searchEmployeeForActivation">
					<div class="row">
					...
					<div class="form-group row">
						<div class="col-sm-offset-2 col-sm-8">
							...
							<!-- <div align="center">
								...
								id="activateEmp" name="activateEmp" data-bb-example-key="confirm-options">						
							</div> -->
							
							<input type="submit" value="Activate Employee"
								class="btn btn-primary btn-block btn-lg" tabindex="9"
								id="activateEmp" name="activateEmp" data-confirm="Are are sure you want to activate this employee?">
							
							<!-- Aikhona this not working for us 
							<br/><br/>
							<p><a  onclick="javascript:showConfirm('Please confirm','Are are sure you want to activate this employee?','Yes','','No','#')"><button class="btn btn-primary btn-block btn-lg" tabindex="9">Deactivate Employee</button></a></p>
