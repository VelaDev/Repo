									...
									<table id="myDatatable" class="display datatable">
										...
										<tbody>
											...
											<c:forEach var="list" items="${displayCustomers}">
												<tr>													
													<td><a href="userViewCustomer?customerName=<c:out value='${list.customerName}'/>">${list.customerName}</a></td>
                                                   	<td>${list.contactEmail}</td>
													<td>${list.telephoneNumber}</td>
                                                    <td><a href="userSearchCustomerDevices?customerName=<c:out value='${list.customerName}'/>">View Devices</a></td>
                                               	</tr>
											</c:forEach>
										</tbody>
									</table>
