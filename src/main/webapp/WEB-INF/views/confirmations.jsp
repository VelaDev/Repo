				 	 ...
				 	 <!-- Add employee -->
				 	  <c:choose>
				 	    <c:when test="${addEmployee =='addEmployee' }">
				 	       <c:out value="${retMessage}"></c:out> Click<a href="displayEmployees.html" class="confirmtions"><b> here</b></a> to view employee you have added or 
				 	  ...
				 	  <c:choose>
				 	    <c:when test="${updateDevice =='updateDevice' }">
				 	       <c:out value="${retMessage}"></c:out> Click<a href="displayDevices.html" class="confirmtions"><b> here</b></a> to view list of Devices.
				 	    </c:when>
				 	    </c:choose>
