				...
				<div class="panel-body">
					<div class="tab-content">
						...
						<form:form class="well form-horizontal" method="post"
							action="updateTicketAdmin" role="form"
									...
									<div class="col-md-6 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"><i
												...
												class="form-control" readonly="readonly" name="ticketNumber"
												value="${ticketupdate.ticketNumber }" type="text">
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"><i
												class="glyphicon glyphicon-calendar"></i></span> <input
												class="form-control" readonly="readonly" name="serialNumber"
												value="${ticketupdate.device.serialNumber}" type="text">
										</div>
									</div>
								</div>
									...
									<div class="col-md-6 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"><i
												...
												value="${ticketupdate.device.customerDevice.customerName }"
												type="text">
										</div>
									</div>
								</div>
									...
									<div class="col-md-6 inputGroupContainer">
										<div class="input-group">
											...
											<textarea class="form-control" readonly="readonly"
												name="subject" required="required">${ticketupdate.subject} </textarea>
										</div>
									</div>
								</div>
									...
									<div class="col-md-6 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"><i
												...
												class="form-control"
												value="${ticketupdate.device.startDate}" type="text">
										</div>
									</div>
								</div>
									...
									<div class="col-md-6 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"><i
												...
												value="${ticketupdate.device.endDate}" class="form-control"
												type="text">
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 selectContainer">
										<div class="input-group">
											<span class="input-group-addon"><i
												class="glyphicon glyphicon-list"></i></span> <select
												readonly="readonly" name="priority"
									...
									<div class="col-md-6 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"><i
												class="glyphicon glyphicon-pencil"></i></span>
											<textarea class="form-control" readonly="readonly"
												name="description">${ticketupdate.description}</textarea>
										</div>
									</div>
								</div>
							</div>
