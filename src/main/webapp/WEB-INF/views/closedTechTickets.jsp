			...
			<div class="panel panel-success">
				...
				<div class="panel-body">
					<div class="tab-content">
								...
								<form:form class="form-horizontal" id="sortByDate" modelAttribute="closedTechDetails" action="closedTechDetails" method="post">
								<div class="col-sm-4">
							...
							<table id="myDatatable" class="display datatable">
								...
								<tbody>
									<c:forEach items="${ticketList}" var="tickets">
										<tr>
											<td><a href="closedTechTicketsDetails?id=<c:out value='${tickets.recordID}'/>"><c:out value="${tickets.ticketNumber}" /></a></td>
