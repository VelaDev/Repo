						...
						<div class="row">
							<div class="content">
									...
									<table id="myDatatable" class="display datatable">
										<thead>
											<tr>
												<th>First Name<img src="resources/bootstrap-3.3.6/images/sort_both.png"></th>
												<th>Last Name<img src="resources/bootstrap-3.3.6/images/sort_both.png"></th>
												<th>Email<img src="resources/bootstrap-3.3.6/images/sort_both.png"></th>
												<th>Status<img src="resources/bootstrap-3.3.6/images/sort_both.png"></th> 
												<th>Role<img src="resources/bootstrap-3.3.6/images/sort_both.png"></th>
												<th>Edit</th>
												<th>Deactivate</th>
											</tr>
										</thead>
										<tbody>
											...
											<c:forEach var="list" items="${displayEmployees}">
												<tr>
													...
													<td>${list.status}</td>
													<td>${list.role}</td>
                                                    <th><a href="updateEmployee?email=<c:out value='${list.email}'/>">edit</a></th>
