			...
			<div class="panel-body">
				<div class="col-lg-10">
					<form action="searchClient" method="post">
						<div class="row">
							<div class="col-xs-11">
								<div class="col-xs-4 form-control-label" for="inputEmail3">Search
									Customer</div>
								<div class="col-xs-5">
							...
							<div class="groupclientdetails">
								...
								<form action="">
									<div class="form-group row">
										<label for="inputEmail3" class="col-sm-6 form-control-label">Company
											Name</label>
										<div class="col-sm-10">
...
<link href="<c:url value="/resources/bootstrap-3.3.6/css/bootstrap.min.css" />" rel="stylesheet" type="text/css" />
 --%>
<link href="<c:url value="/resources/bootstrap-3.3.6/css/Custombootstrap.css" />"rel="stylesheet" type="text/css" />
