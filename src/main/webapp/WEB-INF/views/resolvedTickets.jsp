...
<html lang="en">
<head>
<title>Resolved Tickets | Velaphanda Trading & Projects</title>
<meta charset="utf-8">
							...
							<table id="myDatatable" class="display datatable">
								...
								<tbody>
									<c:forEach items="${ticketList}" var="tickets">
										<tr>
											<td><a href="resolvedTickectDetails?id=<c:out value='${tickets.recordID}'/>"><c:out value="${tickets.ticketNumber}" /></a></td>
