	...
	<div class="velaphanda_containter">	
		...
		<c:if test="${not empty retMessage }">
			...
			<div class="panel panel-success">    
				...
				<form action="deactivateEmployeeByName" method="post" id="searchEmployee">
					<div class="row">
				...
				<br>
				<form:form class="well form-horizontal" method="post" action="deactivateEmployee"
					modelAttribute="deactivateEmployee" id="deactivateEmployee">
