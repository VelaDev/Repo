...
<html lang="en">
<head>
<title>Tickets Dashboard | Velaphanda Trading & Projects</title>
<meta charset="utf-8">
			...
			<div class="panel panel-success">
				...
				<div class="ticket-summary row-fluid">
					...
					<ul class="db-summary clearfix pb20 pt20 clear" id="ticket-summary">
						...
						<li><a href='<c:url value="slaBridged.html"/>' data-parallel-url="#"
						...
						<li><a href='<c:url value="escalatedTech.html"/>' data-parallel-url="#"
							data-parallel-placeholder="#ticket-leftFilter"
							class="summery-filter clearfix" data-pjax="#body-container">
								<div class="db-icon-wrap center pull-left">
						...
						<li><a href='<c:url value="awaitSpares.html"/>' class="summery-filter clearfix"
							data-parallel-url="#"
							data-parallel-placeholder="#ticket-leftFilter"
