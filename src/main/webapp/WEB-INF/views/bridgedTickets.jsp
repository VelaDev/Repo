...
<html lang="en">
<head>
<title>Bridged Tickets | Velaphanda Trading & Projects</title>
<meta charset="utf-8">
							...
							<table id="myDatatable" class="display datatable">
								...
								<tbody>
									<c:forEach items="${ticketList}" var="tickets">
										<tr>
											<td><a href="bridgedTicketsDetails?id=<c:out value='${tickets.recordID}'/>"><c:out value="${tickets.ticketNumber}" /></a></td>
